...
/*
    To make code more readable, will move code from the EmployeeOverview.razor
    file to here
*/

namespace BethanysPieShopApp
{
    public partial class EmployeeOverview // Blazor creates partial classes
    {
